    ...
    Process {
        ...
        stdout: StdioCollector {
            ...
            onStreamFinished: {
                ...
                if (root.dateResolver) {
                    root.dateResolver(output);
                    root.dateResolver = null; // Flush reference slot
                }
            }
        }
