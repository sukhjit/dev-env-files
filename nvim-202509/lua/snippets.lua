...
-- Key mappings
vim.keymap.set('n', '<leader>te', FloatingTerminal, { noremap = true, silent = true, desc = '[T]oggle floating t[e]rminal' })
...
end, { noremap = true, silent = true, desc = '[D]isable transparent background' })
...
end, { noremap = true, silent = true, desc = 'Enable transparent background' })
